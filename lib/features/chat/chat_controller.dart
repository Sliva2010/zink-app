...
- Не используй markdown-разметку: никаких **жирных**, *курсивных*, ### заголовков, `кода`, списков с *.
- Пиши обычным текстом. Для выделения используй только заглавные буквы или двоеточие.
''';
  }
